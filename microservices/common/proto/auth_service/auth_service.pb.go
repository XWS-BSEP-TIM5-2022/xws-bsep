...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x33, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x6e,
	...
	0x9f, 0x03, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x2a, 0x42, 0x48, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_auth_service_proto_goTypes = []interface{}{
	...
	(*UpdateUsernameRequest)(nil),   // 2: auth_service.UpdateUsernameRequest
	(*UpdateUsernameResponse)(nil),  // 3: auth_service.UpdateUsernameResponse
	(*Empty)(nil),                   // 4: auth_service.Empty
	(*GetAllResponse)(nil),          // 5: auth_service.GetAllResponse
	(*Auth)(nil),                    // 6: auth_service.Auth
	(*RegisterRequest)(nil),         // 7: auth_service.RegisterRequest
	(*Education)(nil),               // 8: auth_service.Education
	(*Experience)(nil),              // 9: auth_service.Experience
	(*Skill)(nil),                   // 10: auth_service.Skill
	(*Interest)(nil),                // 11: auth_service.Interest
	(*RegisterResponse)(nil),        // 12: auth_service.RegisterResponse
...
var file_auth_service_proto_depIdxs = []int32{
	6,  // 0: auth_service.GetAllResponse.auth:type_name -> auth_service.Auth
	0,  // 1: auth_service.RegisterRequest.gender:type_name -> auth_service.RegisterRequest.GenderEnum
	15, // 2: auth_service.RegisterRequest.birthday:type_name -> google.protobuf.Timestamp
	8,  // 3: auth_service.RegisterRequest.education:type_name -> auth_service.Education
	9,  // 4: auth_service.RegisterRequest.experience:type_name -> auth_service.Experience
	10, // 5: auth_service.RegisterRequest.skills:type_name -> auth_service.Skill
	11, // 6: auth_service.RegisterRequest.interests:type_name -> auth_service.Interest
	1,  // 7: auth_service.Education.level:type_name -> auth_service.Education.EducationEnum
	15, // 8: auth_service.Education.startDate:type_name -> google.protobuf.Timestamp
	15, // 9: auth_service.Education.endDate:type_name -> google.protobuf.Timestamp
	15, // 10: auth_service.Experience.startDate:type_name -> google.protobuf.Timestamp
	15, // 11: auth_service.Experience.endDate:type_name -> google.protobuf.Timestamp
	7,  // 12: auth_service.AuthService.Register:input_type -> auth_service.RegisterRequest
	13, // 13: auth_service.AuthService.Login:input_type -> auth_service.LoginRequest
	4,  // 14: auth_service.AuthService.GetAll:input_type -> auth_service.Empty
	2,  // 15: auth_service.AuthService.UpdateUsername:input_type -> auth_service.UpdateUsernameRequest
	12, // 16: auth_service.AuthService.Register:output_type -> auth_service.RegisterResponse
	14, // 17: auth_service.AuthService.Login:output_type -> auth_service.LoginResponse
	5,  // 18: auth_service.AuthService.GetAll:output_type -> auth_service.GetAllResponse
	3,  // 19: auth_service.AuthService.UpdateUsername:output_type -> auth_service.UpdateUsernameResponse
