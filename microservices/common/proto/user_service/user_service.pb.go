...
var file_user_service_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xbf, 0x01, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x52, 0x0a, 0x06, 0x47, 0x65, 0x74,
	0x41, 0x6c, 0x6c, 0x12, 0x1b, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x3a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x48, 0x5a, 0x46, 0x67,
...
var file_user_service_proto_goTypes = []interface{}{
	(*GetAllRequest)(nil),      // 0: user_service.GetAllRequest
	(*GetAllResponse)(nil),     // 1: user_service.GetAllResponse
	...
	(*InsertRequest)(nil),      // 5: user_service.InsertRequest
	(*InsertResponse)(nil),     // 6: user_service.InsertResponse
}
var file_user_service_proto_depIdxs = []int32{
	2, // 0: user_service.GetAllResponse.users:type_name -> user_service.User
	2, // 1: user_service.CreateUserRequest.user:type_name -> user_service.User
	2, // 2: user_service.CreateUserResponse.user:type_name -> user_service.User
	2, // 3: user_service.InsertRequest.user:type_name -> user_service.User
	0, // 4: user_service.UserService.GetAll:input_type -> user_service.GetAllRequest
	5, // 5: user_service.UserService.CreateUser:input_type -> user_service.InsertRequest
	1, // 6: user_service.UserService.GetAll:output_type -> user_service.GetAllResponse
	6, // 7: user_service.UserService.CreateUser:output_type -> user_service.InsertResponse
