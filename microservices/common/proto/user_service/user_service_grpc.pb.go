...
type UserServiceClient interface {
	...
	CreateUser(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error)
}
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
...
type UserServiceServer interface {
	...
	CreateUser(context.Context, *InsertRequest) (*InsertResponse, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *InsertRequest) (*InsertResponse, error) {
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateUser(ctx, req.(*InsertRequest))
	}
	return interceptor(ctx, in, info, handler)
}
